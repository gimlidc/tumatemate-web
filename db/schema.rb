...
ActiveRecord::Schema.define(:version => 20130820175233) do
  ...
  create_table "products", :force => true do |t|
    ...
    t.string   "image_medium_file_name"
    t.string   "image_medium_content_type"
    t.integer  "image_medium_file_size"
    t.datetime "image_medium_updated_at"
